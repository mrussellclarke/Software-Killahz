...
public boolean validateLogin(String id, String password) throws SQLException, NoSuchAlgorithmException, InvalidKeySpecException
{
	Connection conn;
	conn = getConnection();
    ...
    {//changed id to String
     ...
     String dataBasePw=  rs.getString("password").replaceAll("\\s+","");
		  	if(idNumber.equals(id)&&encrypt.validatePassword(password,dataBasePw))
		  	{	
